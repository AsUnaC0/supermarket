  ...
  <div class="cart">
    ...
    <div class="footer-fixed">
      ...
      <div class="all-total">
        ...
        <div v-if="!isEdit" class="goPay" :class="{disabled: !selCount}" @click="goPay">结算({{selCount}})</div>
        <div v-else @click="handleDel" class="delete" :class="{disabled: !selCount}">删除</div>
      </div>
    </div>
  </div>
